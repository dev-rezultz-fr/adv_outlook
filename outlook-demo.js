$(function() {
  ...
  if (typeof(Storage) === 'undefined') {
    ...
    var redirectUri = 'http://127.0.0.1:8081/Outlook';
    var appId = '10fd4e6d-360b-4ac1-b1ac-0d9199fddd7c';
    ...
    var pagemap = {
      ...
      // Error display
        '#error': function () {
            ...
            if (errorresponse.error === 'login_required' || errorresponse.error === 'interaction_required') {
